...
public class PerformanceMeasurement {
	...
	private static final int NumOfTests = 800;         // 테스트를 수행할 횟수
	private static final int FirstTestSize = 10;   // 초기 배열의 크기
	private static final int SizeIncrement = 3;   // 테스트할 배열의 크기 증가율
