public class AppController {
	...
	{
		char frontElement = (char)this._arrayQueue.frontElement();
		if(frontElement != 0)
	...
	{
		int queueSize = this._arrayQueue.size();
		if(queueSize != 0)
	...
	public void showAll()
	{
		...
		for(int i = this._arrayQueue.front(); i != this._arrayQueue.rear(); i++)
		{
			if(i == this._arrayQueue.maxSize())
				i = 0;
			this._appView.outputEachElement((char)this._arrayQueue.elementAt(i));
		}
	...
	{
		if(this._arrayQueue.enQueue(new Character(c)))
		{
	...
	public void removeOne()
	{
		...
		{
			this._appView.outputRemoveElement((char)this._arrayQueue.deQueue());
		}
	}
	...
	{
		for(int i = this._arrayQueue.size(); i>0; i--)
		{
			this._appView.outputRemoveElement((char)this._arrayQueue.deQueue());
		}
